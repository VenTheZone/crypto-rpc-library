...
|------|-----|----------------|---------------------|-------|
| BlockPi | `https://arbitrum.blockpi.network/v1/rpc/public` | 0 | 2026-04-21 | Rate limited |
| QuickNode | `https://*.quiknode.pro/` | 0 | 2026-04-21 | Requires API key |
| Alchemy | `https://arb-mainnet.g.alchemy.com/v2/demo` | 0 | 2026-04-21 | Requires API key |
| Infura | `https://arbitrum-mainnet.infura.io/v3/` | 0 | 2026-04-21 | Requires API key |
| Blast | `https://arbitrum-mainnet.public.blastapi.io` | 0 | 2026-04-21 | Connection error |
| Offchain | `https://arb1.offchain.cc` | 0 | 2026-04-21 | Connection error |
