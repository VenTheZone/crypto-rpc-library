...
| ---- | --- | ----------- | --- | --- | ------- | ------- | ------ |
| Arbitrum | https://arb1.arbitrum.io/rpc | - | 142 | 7 | no | **yes** | working |
| PublicNode | https://arbitrum-one-rpc.publicnode.com | - | 135 | 16 | no | **yes** | working |
| Ankr | https://rpc.ankr.com/arbitrum | - | 119 | - | no | **yes** | working |
...
| DRPC | https://arbitrum.drpc.org | - | 173 | 11 | no | **yes** | working |
