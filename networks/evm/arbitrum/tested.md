...
| ---- | --- | ----------- | --- | --- | ------- | ------- | ------ |
| Arbitrum | https://arb1.arbitrum.io/rpc | - | 112 | 24 | no | **yes** | working |
| PublicNode | https://arbitrum-one-rpc.publicnode.com | - | 138 | 16 | no | **yes** | working |
| Ankr | https://rpc.ankr.com/arbitrum | - | 202 | - | no | **yes** | working |
...
| DRPC | https://arbitrum.drpc.org | - | - | - | no | **yes** | working |
