...
| ---- | --- | ----------- | --- | --- | ------- | ------- | ------ |
| Arbitrum | https://arb1.arbitrum.io/rpc | - | 65 | 68 | no | **yes** | working |
| PublicNode | https://arbitrum-one-rpc.publicnode.com | - | 100 | 63 | no | **yes** | working |
| Ankr | https://rpc.ankr.com/arbitrum | - | 306 | - | no | **yes** | working |
...
| DRPC | https://arbitrum.drpc.org | - | 345 | 46 | no | **yes** | working |
